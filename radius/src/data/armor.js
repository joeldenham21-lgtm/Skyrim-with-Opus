...
export const ARMOR = Object.fromEntries([
  ...
  V('vest_6b23_2', { name: '6B23-2', cls: 4, durability: 130, weight: 8.4, price: 15000, rank: 3, rarity: 'rare', zones: ['torso', 'stomach'], speed: 0.97, stamina: 1.1 }),
  V('vest_zhuk',   { name: 'Zhuk-3 plate carrier', cls: 4, durability: 120, weight: 7.0, price: 17000, rank: 3, rarity: 'rare', zones: ['torso'], speed: 0.98, stamina: 1.06, desc: 'Ceramic plates front and back. Sides are cloth.' }),
  V('vest_iotv',   { name: 'IOTV with ESAPI', cls: 5, durability: 150, weight: 10.5, price: 30000, rank: 4, rarity: 'rare', zones: ['torso', 'stomach'], speed: 0.95, stamina: 1.15 }),
  V('vest_6b43',   { name: '6B43', cls: 6, durability: 180, weight: 14.5, price: 46000, rank: 5, rarity: 'epic', zones: ['torso', 'stomach', 'arms'], speed: 0.9, stamina: 1.25, desc: 'Full coverage. You will hear yourself breathing.' }),
  V('vest_fort',   { name: 'FORT Defender-2', cls: 5, durability: 170, weight: 12.0, price: 36000, rank: 4, rarity: 'epic', zones: ['torso', 'stomach', 'arms'], speed: 0.93, stamina: 1.2 }),
  // ---- helmets ----
  ...
  H('helm_zsh',    { name: 'ZSh-1-2M', cls: 4, durability: 110, weight: 3.4, price: 14000, rank: 4, rarity: 'rare', visor: true, desc: 'Visor down: the world through a scratch.' }),
  H('helm_altyn',  { name: 'Altyn', cls: 4, durability: 130, weight: 4.0, price: 24000, rank: 5, rarity: 'epic', visor: true, stamina: 1.05, desc: 'Titanium with a visor. Committee issue for the Column.' }),
  ...
  P('pack_tortilla', { name: 'Tortilla daypack', capacity: 12, weight: 0.6, price: 900, desc: '20 litres.' }),
  P('pack_pilgrim', { name: 'Pilgrim pack', capacity: 20, weight: 1.1, price: 3200, rank: 2, rarity: 'uncommon', desc: '30 litres.' }),
  P('pack_attack2', { name: 'Attack 2 pack', capacity: 30, weight: 1.6, price: 7600, rank: 3, rarity: 'uncommon', desc: '45 litres.' }),
  P('pack_6sh118', { name: '6Sh118 raid pack', capacity: 42, weight: 2.4, price: 15000, rank: 4, rarity: 'rare', speed: 0.98, desc: '60 litres. The frame creaks.' }),
  ...
  R('rig_tv110',   { name: 'TV-110 plate carrier rig', readyMags: 6, quick: 4, weight: 2.4, price: 11000, rank: 4, rarity: 'rare', armor: 1, desc: 'Pouches over a soft insert. Wears under a vest.' }),
  R('rig_smersh',  { name: 'SMERSH vest', readyMags: 8, quick: 4, weight: 1.6, price: 8600, rank: 3, rarity: 'rare' }),
  ...
  G('head_pnv57',  { name: 'PNV-57E night vision', price: 17000, rank: 3, rarity: 'rare', weight: 0.9, nvg: 1, battery: true, desc: 'Gen 1 tubes. Grain and bloom. Phantoms show.' }),
  G('head_1pn138', { name: '1PN138 night vision', price: 38000, rank: 4, rarity: 'epic', weight: 0.7, nvg: 2, battery: true, desc: 'Gen 2+. Clean picture.' }),
  // ---- masks ----
