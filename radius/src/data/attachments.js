...
export const ATTACHMENTS = Object.fromEntries([
  ...
  T('rail_mosin',    { name: 'Mosin scope mount', slot: 'rail', fits: ['mosin'], gives: { top: 'pu' }, price: 300, rank: 2, rarity: 'common', weight: 0.2 }),
  // optics: dovetail
  ...
  T('opt_pu',        { name: 'PU 3.5×', slot: 'top', fits: ['pu'], price: 900, rank: 2, rarity: 'uncommon', weight: 0.3, effects: { zoom: 3.5, reticle: 'pu', adsSpeed: 0.85, moa: 0.75 } }),
  // optics: picatinny
  ...
  T('muz_dtk1',      { name: 'DTK-1 muzzle brake', slot: 'muzzle', fits: ['m14', 'm24'], price: 700, rank: 2, rarity: 'common', weight: 0.15, effects: { recoil: 0.8, noise: 1.15, flash: 1.2 } }),
