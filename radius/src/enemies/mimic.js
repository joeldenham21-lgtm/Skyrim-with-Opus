// STUB — owned by an enemies agent. Registers the 'mimic' type. See DESIGN.md §6 and ARCHITECTURE.md §Enemies.
...
export function registerMimic(ctx) { ctx.enemies.registerType('mimic', Mimic); }
