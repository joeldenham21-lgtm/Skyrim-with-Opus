// STUB — owned by an enemies agent. Registers the 'spawn' type. See DESIGN.md §6 and ARCHITECTURE.md §Enemies.
import * as THREE from 'three';
import { Enemy } from './common.js';
class Spawn extends Enemy {
  constructor(ctx, position, opts) {
    super(ctx, 'spawn', position, Object.assign({ hp: 90 }, opts));
...
export function registerSpawn(ctx) { ctx.enemies.registerType('spawn', Spawn); }
